...
public class AuthController {
    ...
    @GetMapping("/login")
    public String authenticate(@ModelAttribute("user") User user, HttpServletResponse response) {
        if (UserData.authenticate(user)) {
            ...
            return "redirect:/main"; //todo добавить
        }
        return "auth";
    }
    ...
    public ModelAndView registrationPage() {
        return new ModelAndView("registration","user",new User()); //todo добавить
    }
